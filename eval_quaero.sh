...
java -cp ../QUAERO_FrenchMed/eval/BRATeval-2015-04-24.jar au.com.nicta.csp.brateval.CompareNotesEHealth results/$resdir  $corpus true >> results/$res1

res2="$corpusname"`basename $corpusdir`_"$ontologies"_CUI_em"$expandMappings"_"$format"_PM.txt
java -cp ../QUAERO_FrenchMed/eval/BRATeval-2015-04-24.jar au.com.nicta.csp.brateval.CompareNotesEHealth results/$resdir  $corpus false >> results/$res2
